...
class SongModel(id: Int,artist: String, duration: String, title: String, album: String, genre: String, year: String, dir: String) {
    var id : Int = 0
    var artist : String? = "NO"
    var duration : String? = "NO"
    var title : String? = "NO"
    var album : String? = "NO"
    var genre : String? = "NO"
    var year : String? = "NO"
...
class MPlayer : Application() {
    ...
    override fun start(primaryStage: Stage) {
            ...
            init {
                ...
                val vbox = object : VBox() {
                    init {
                        ...
                        volumeSlider.setMajorTickUnit(10.0);
                        volumeSlider.setMinorTickCount(5);
                        volumeSlider.setSnapToTicks(true);

                        var orintationL : FlowPane = FlowPane(curTrackTime)
                        orintationL.setAlignment(Pos.BASELINE_RIGHT)
                        children.addAll(curMusicLabel, musicSlider, orintationL)
                        ...
                        val hbox = object : HBox() {
                            init {
                                ...
                                var buttonC : FlowPane = FlowPane(prevButton, playButton, pauseButton, stopButton, nextButton)
                                buttonC.setAlignment(Pos.BASELINE_CENTER)
                                buttonC.setHgap(15.0)
                                children.addAll(buttonC)
                            }
                        }
                        children.addAll(hbox, volumeSlider)
                    }
                }
        ...
        val scene = Scene(root, 400.0, 478.0)
